...
(function(){document.addEventListener( 'DOMContentLoaded', function() {
	...
	document.querySelectorAll('.js-variation-select').forEach(function(element) {
	    element.removeAttribute('disabled')
		element.addEventListener( 'input', function(e) {
	    	// console.dir(this)
	    	// console.log(this.name)
	    	var var_id = this.value.split('|')[0]
	    	var var_attr = this.value.split('|')[1]
	    	var form = document.querySelector('.js-product-'+this.name)
	    	// console.log(form)
	    	form.querySelector('.js-varid-input').value = var_id
	    	form.querySelector('.js-attr-input').value = var_attr
	    } );
	});
